...
//         c
//         await pages('primaryPage').primaryComponent.searchSetting.setValue(valuesForFields.searchingBoard);
//         await pages('primaryPage').primaryComponent.resultsOpeningBtn.waitForDisplayed({ timeout: 10000 });
//         await pages('primaryPage').primaryComponent.resultsOpeningBtn.click();
//         await browser.waitUntil(async () => {
