...
class BoardComponent extends BaseComponent {
    ...
    createBtn(name){
        const selectors={
            list:'//button[@data-testid="list-composer-button"]',
    ...
    addBtn(name){
        const selectors={
            list:'//button[text()="Додати список"]',
            card:'//button[text()="Додати картку"]',
        }
        return this.rootEL.$(selectors[name])
    }
    ...
    input(name){
        const selectors={
            ...
            card:'//textarea[@data-testid="list-card-composer-textarea"]'
        }
        return this.rootEL.$(selectors[name])
    }
